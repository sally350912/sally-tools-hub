...
window.Atelier = (function(){
  ...
  function numerology(el){
    const D={
      '1':{t:'領導者',d:'天生的開創者，獨立、有主見、行動力強，認定目標就往前衝。盲點是固執、不愛被指揮，有時顯得強勢。',talk:'講重點、給選項讓他自己拍板，讓他覺得決定是他做的。',no:'別囉嗦、別替他做主。'},
      '2':{t:'協調者',d:'細膩體貼、善於傾聽與配合，是團隊裡的潤滑劑。重視關係與和諧、怕衝突，容易委屈自己、想太多。',talk:'溫和、耐心、多傾聽，給足安全感再慢慢推進。',no:'別逼、別給壓力。'},
      '3':{t:'表達者',d:'開朗、有創意、感染力強，天生會聊也愛分享。靠感覺做事，優點是有魅力，盲點是三分鐘熱度、情緒起伏大。',talk:'氣氛輕鬆有趣，給他舞台講、多真心稱讚。',no:'別太嚴肅、別潑冷水。'},
      '4':{t:'實務者',d:'腳踏實地、有紀律、重視規則與安全感，做事可靠。不喜歡變動與冒險，盲點是固執、放不開、糾結細節。',talk:'有條理、給數據與步驟、說到做到。',no:'別空談、別臨時改規則。'},
      '5':{t:'自由者',d:'好奇、靈活、愛冒險，討厭被框住，學東西快、適應力強。盲點是善變、難專一、容易衝動。',talk:'給彈性與選擇、節奏明快講重點。',no:'別一堆規則、別逼他承諾。'},
      '6':{t:'照顧者',d:'溫暖、有責任感，重視家庭與被需要的感覺，願意付出。盲點是愛操心、容易過度犧牲、對人對己標準都高。',talk:'真誠、顧及他在乎的人、強調保障與安心。',no:'別只談自己、別誇大。'},
      '7':{t:'思考者',d:'理性、愛鑽研、追求真相與深度，需要獨處空間，有洞察力。盲點是多疑、難親近、想太多而慢行動。',talk:'給資料讓他自己判斷、尊重他的步調。',no:'別硬推、別過度熱情。'},
      '8':{t:'實現者',d:'目標導向、有企圖心，重視成就、金錢與效率，天生會扛責任。盲點是工作狂、控制慾、把價值跟成果綁太緊。',talk:'專業、直接談價值與投報、尊重他的地位與時間。',no:'別拖泥帶水、別佔用他時間。'},
      '9':{t:'理想者',d:'心胸寬大、有同理心，重視意義與付出，想讓事情更好。盲點是想太多、容易心軟、界線不清、理想與現實有落差。',talk:'談願景、價值與對別人的幫助。',no:'別只談錢、別太現實。'},
      '11':{t:'啟發者（大師數）',d:'直覺敏銳、有理想與感染力，能啟發別人。但很敏感、容易內耗，理想太高時會給自己很大壓力。',talk:'真誠有深度、給他靈感與認同。',no:'別敷衍、別只講表面。'},
      '22':{t:'大建築師（大師數）',d:'兼具大格局與執行力，能把理想真的蓋出來。承擔得多、要求高，壓力大時容易硬撐。',talk:'談長遠藍圖＋具體落地做法，兩個都要給。',no:'別小家子氣、別只看眼前。'},
      '33':{t:'大導師（大師數）',d:'充滿愛與奉獻精神，重視教育、療癒與成全別人。容易把別人的事扛在身上，要學會先照顧自己。',talk:'強調對人的幫助與成長、用溫度溝通。',no:'別太功利、別冷冰冰。'}
    };
